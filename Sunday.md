...
news_data <- news_data %>% filter(days=="Sunday") %>% select(-url, -timedelta)
news_data
```
    ...
    ##  7             12              190           0.622             1.00
    ##  8             13              174           0.659             1.00
    ##  9             10             1245           0.433             1.00
    ## 10             16               83           0.843             1.00
    ## # ... with 2,727 more rows, and 56 more variables:
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 6.415186e+03 9.333120e-03 3.087291e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 6.367580e+03 2.304914e-02 3.018645e+03
