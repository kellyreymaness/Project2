...
news_data <- news_data %>% filter(days=="Wednesday") %>% select(-url, -timedelta)
news_data
```
    ...
    ##  2              9              180           0.630             1.00
    ##  3              9              759           0.499             1.00
    ##  4             13             1226           0.436             1.00
    ##  5              6              241           0.660             1.00
    ##  6              9              168           0.778             1.00
    ##  7             10             1121           0.418             1.00
    ##  8              7             1174           0.458             1.00
    ##  9              7              376           0.569             1.00
    ## 10              9              142           0.714             1.00
    ## # ... with 7,425 more rows, and 56 more variables:
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.949669e+04 3.678151e-03 3.309615e+03
